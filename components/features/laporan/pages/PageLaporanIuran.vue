<template>
  <div>
    <content-body title="Laporan Pembayaran Iuran Tahunan" icon="fas fa-file-signature">
        ...
        <div class="shadow p-2.5 border rounded mt-4">
          <div v-if="rows && rows.length > 0" id="print-body" class="overflow-x-auto pb-4">
            ...
            <div class="text-center text-h5 font-semibold text-black border-t border-black pb-4">
              <p class="pt-2">Laporan Pembayaran Iuran Tahunan</p>
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 'sisaBayar', text: 'Sisa Bayar', align: 'center' },
  ...
  methods: {
    ...
    handleDownload(): void {
      ...
      const options = {
        margin: 3,
        filename: `laporan-pembayaran-iuran.pdf`,
